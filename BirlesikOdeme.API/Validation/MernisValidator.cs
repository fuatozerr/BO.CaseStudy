...
{
    public class MernisValidator : AbstractValidator<VatandasRequestModel>
    {
        public MernisValidator()
        {
            ...
            RuleFor(a => a.TcKimlikNo).NotNull().NotEmpty().Must(w => w.ToString().Length == 11).WithMessage("Tc Kimlik No 11 karakter olmak zorundadır.");
